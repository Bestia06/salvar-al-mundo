...
export class EffectsManager {
     ...
     */
    static async showParticleEffect(type: 'fire' | 'smoke' | 'spark' | 'energy'): Promise<void> {
        const particles = {
            fire: '🔥',
            smoke: '💨',
            spark: '✨',
     ...
     */
    static async screenShake(intensity: number = 3): Promise<void> {
        const frames = 10;
     ...
     */
    static async screenFlash(color: 'red' | 'white' | 'yellow' | 'blue'): Promise<void> {
        const flashFrames = 3;
     ...
     */
    static async shockwaveEffect(): Promise<void> {
        const frames = 8;
     ...
     */
    static async energyBeamEffect(): Promise<void> {
        const frames = 6;
     ...
     * Efecto de humo
     */
    static async smokeEffect(): Promise<void> {
        const frames = 10;
     ...
     */
    static async chainExplosionEffect(): Promise<void> {
        const explosions = [
            { x: 20, y: 10 },
            { x: 40, y: 8 },
            { x: 60, y: 12 },
     ...
     */
    private static async showExplosionAt(x: number, y: number): Promise<void> {
        const frames = 4;
     ...
     */
    static async energyChargeEffect(): Promise<void> {
        const frames = 8;
