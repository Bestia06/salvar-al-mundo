...
exports.CalculosManager = void 0;
...
class CalculosManager {
     ...
     */
    static validarCoordenadas(x1, y1, x2, y2) {
     ...
     * @returns Objeto con validación y mensaje
     */
    static validarCodigoSeguridad(codigo) {
        // Verificar longitud
        if (codigo.length !== 10) {
            return {
                valido: false,
     ...
     */
    static async simularSecuenciaDespegue(duracionMinutos = 2, callback) {
     ...
     * @param y2 Coordenada Y del segundo punto
     */
    static mostrarCalculoDistancia(x1, y1, x2, y2) {
     ...
     */
    static mostrarCodigoSeguridad(codigo) {
        console.log(chalk.blue.bold(`
    ╔══════════════════════════════════════════════════════════════════════════════╗
    ║                                                                              ║
...
exports.CalculosManager = CalculosManager;
